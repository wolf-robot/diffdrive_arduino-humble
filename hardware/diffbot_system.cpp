  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  wheel_b_l_.setup(cfg_.back_left_wheel_name, cfg_.enc_counts_per_rev);
  wheel_b_r_.setup(cfg_.back_right_wheel_name, cfg_.enc_counts_per_rev);
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
  ...
  comms_.read_encoder_values(wheel_f_l_.enc, wheel_f_r_.enc, wheel_b_l_.enc, wheel_b_r_.enc);
  ...
  wheel_b_l_.pos = wheel_b_l_.calc_enc_angle();
  wheel_b_l_.vel = (wheel_b_l_.pos - pos_prev) / delta_seconds;

  pos_prev = wheel_b_r_.pos;
  wheel_b_r_.pos = wheel_b_r_.calc_enc_angle();
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  comms_.set_motor_values(motor_f_l_counts_per_loop, motor_f_r_counts_per_loop, motor_b_l_counts_per_loop, motor_b_r_counts_per_loop);
  return hardware_interface::return_type::OK;
}
